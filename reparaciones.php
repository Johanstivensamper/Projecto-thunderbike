      ...
      <?php
        ...
        if ($result->num_rows > 0) {
            while($row = $result->fetch_assoc()) {
                ...
                echo "<td>";
                echo "<a href='editar_reparacion.php?id=" . htmlspecialchars($row['id']) . "' class='btn'>Editar</a> ";
                echo "<a href='eliminar_reparacion.php?id=" . htmlspecialchars($row['id']) . "' class='btn' onclick='return confirm(\"¿Estás seguro de que deseas eliminar esta reparación?\");'>Eliminar</a>";
                echo "</td>";
                echo "</tr>";
            }
        } else {
